...
print(VERSION)
print(__file__[len(__file__) - (5 + len(str(VERSION))): len(__file__) - 3], 'room')
...
class Room:
    def __init__(self, coordinate, biome, num, isRun, depth=0):
        ...
        if self.isRun:
            ...
            if type(coordinateToRoom([coordinate[0], coordinate[1], 0])) == tuple and depth != 0:
...
trueRoom = lambda c, b, n, d=0: Room(c, b, n, d)
